...
from augmentations.AugMix import AugMixMiniImageNet
from augmentations.AugMix import aug
...
elif args.dataset =='augMixMiniImageNet':
    n_epochs = 300
    dataset_class = AugMixMiniImageNet
    num_input_channels = 3
    lstm_input_size = 1600
